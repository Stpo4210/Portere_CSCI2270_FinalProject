...
void player::questions(){
    bool running = true;
    string input;
    while(running)
    {
        cout << "======Help Menu====="<<endl;
        cout << "1. What are gems?" << endl;
        cout << "2. What are Weapons?" << endl;
        cout << "3. What's my goal?" << endl;
        cout << "4. What are Markers?" << endl;
        cout << "5. Exit Help Menu"
        getline(cin, input);
        if(input == "1")
            cout << "gems are what you are here to collect. There are gems hidden around the maze that you need to find to leave" << endl;
        else if(input == "2")
            cout << "The maze is a dangerous place, you need weapons to protect yourself from thing both inside and out." << endl;
        else if(input == "3")
            cout << "The standard Labyrinth goal, find the treasure, kill your foes, and escape with your riches." << endl;
        else if(input == "4")
            cout << "Markers are things you can put down in each room to help remember where you are or have been. You can write messages to yourself to get hints." << endl;
        else if(input == "5")
            running = false;
    }
}
